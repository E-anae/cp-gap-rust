...
pub const gapcom_msg_t_GAPCOM_MSG_MIN: gapcom_msg_t = 0;
pub const gapcom_msg_t_GAPCOM_MSG_PING_REQ: gapcom_msg_t = 0;
pub const gapcom_msg_t_GAPCOM_MSG_PING_RESP: gapcom_msg_t = 1;
pub const gapcom_msg_t_GAPCOM_MSG_SET_LOG_VERBOSITY_REQ: gapcom_msg_t = 2;
pub const gapcom_msg_t_GAPCOM_MSG_SET_LOG_VERBOSITY_RESP: gapcom_msg_t = 3;
pub const gapcom_msg_t_GAPCOM_MSG_SET_GYROSCOPE_REQ: gapcom_msg_t = 4;
pub const gapcom_msg_t_GAPCOM_MSG_SET_GYROSCOPE_RESP: gapcom_msg_t = 5;
pub const gapcom_msg_t_GAPCOM_MSG_SET_VERSION_REQ: gapcom_msg_t = 6;
pub const gapcom_msg_t_GAPCOM_MSG_SET_VERSION_RESP: gapcom_msg_t = 7;
pub const gapcom_msg_t_GAPCOM_MSG_GET_VERSION_REQ: gapcom_msg_t = 8;
pub const gapcom_msg_t_GAPCOM_MSG_GET_VERSION_RESP: gapcom_msg_t = 9;
pub const gapcom_msg_t_GAPCOM_MSG_SELFTEST_REQ: gapcom_msg_t = 10;
pub const gapcom_msg_t_GAPCOM_MSG_SELFTEST_RESP: gapcom_msg_t = 11;
pub const gapcom_msg_t_GAPCOM_MSG_POWER_SAVE_MODE_REQ: gapcom_msg_t = 12;
pub const gapcom_msg_t_GAPCOM_MSG_POWER_SAVE_MODE_RESP: gapcom_msg_t = 13;
pub const gapcom_msg_t_GAPCOM_MSG_MAX: gapcom_msg_t = 14;
